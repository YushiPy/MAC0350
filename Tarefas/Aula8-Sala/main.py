...
async def _curtidas(request: Request):
    return templates.TemplateResponse(
        "curtidas.html", {"request": request, "curtidas": curtidas}
    )
...
async def professor_page(request: Request):
    return templates.TemplateResponse(
        "professor-page.html", {"request": request, "static": "/static/professor-page"}
    )
...
async def jupiterweb(request: Request):
    return templates.TemplateResponse(
        "jupiterweb.html", {"request": request, "static": "/static/jupiterweb"}
    )
